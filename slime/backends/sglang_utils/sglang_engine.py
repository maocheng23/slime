...
class SGLangEngine(RayActor):
    def __init__(self, args, rank: int, worker_type: str = "regular", base_gpu_id: int | None = None):
        ...
        self._default_http_timeout_sec = 30.0
        self._weight_update_http_timeout_sec = 300.0
        self._weight_update_http_max_attempts = 6
        self._weight_update_http_retry_backoff_sec = 1.0
...
def _compute_server_args(
    ...
    kwargs = {
        ...
        "base_gpu_id": base,
        # parallel
        "tp_size": args.sglang_tp_size if args.sglang_tp_size is not None else args.rollout_num_gpus_per_engine,
